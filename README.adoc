...
*** Aproximately mid-2010 to 2020 (the 9G was introduced mid-2013 and started to replace the 722.9).

**There are a few ways I would advise you to find out what oil you need:**
...
* Drain a few drops of oil from your transmission to find out if its red or blue/green/blue gren.
...
You can also take a look at the https://github.com/PetterVennberg/722.9-oil-change/tree/main/ReferenceDocs[reference documentation in this GitHub repository] for additional details.

It´s also possible to fill the transmission through the oil cooler lines instead of the fill plug on the transmission. https://mbworld.org/forums/r-class-w251/915950-r350-transmission-flush.html#post9190477[See this post for details.]
